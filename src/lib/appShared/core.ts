...
const DEFAULT_CW_PROFILE_REGISTRY_CONTRACT_ADDRESS = '0xf37196Fafe760E92d3542D837a1595B2a625F618';
const configuredProfileRegistryAddress = import.meta.env.VITE_CW_PROFILE_REGISTRY_CONTRACT_ADDRESS?.trim() ?? '';
export const CW_PROFILE_REGISTRY_CONTRACT_ADDRESS =
  configuredProfileRegistryAddress && /^0x[a-fA-F0-9]{40}$/.test(configuredProfileRegistryAddress)
    ? configuredProfileRegistryAddress
    : DEFAULT_CW_PROFILE_REGISTRY_CONTRACT_ADDRESS;
